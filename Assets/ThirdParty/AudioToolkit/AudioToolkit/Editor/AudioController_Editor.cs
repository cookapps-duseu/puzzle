...
namespace CS.AudioToolkit.Editor
{
    ...
    public partial class AudioController_Editor : EditorEx
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ( HeaderFoldout( ref categoryFoldout, "Category Settings") )
            {
                ...
                if ( curCat != null )
                {
                    ...
                    curCat.playWithZeroVolume = (AudioCategory.PlayWithZeroVolumeOptions)EnumPopup( "Play With Zero Volume", curCat.playWithZeroVolume, "If disabled Play() calls with a volume of zero will not create an AudioObject." );
        ...
        {
            return EditorApplication.isPlaying && AudioController.DoesInstanceExist() && AC.gameObject.scene.IsValid();
        }
