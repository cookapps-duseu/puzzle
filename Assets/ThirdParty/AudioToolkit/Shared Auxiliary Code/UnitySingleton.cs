...
namespace CS.Essentials
{
    ...
    public class UnitySingleton<T> where T : MonoBehaviour
    {
        ...
        // this class should work without .IsNull() extension method in CS.Essentials
        private static bool _IsNull<T2>( T2 obj ) where T2 : class
        ...
        static public T GetSingleton( bool throwErrorIfNotFound, bool autoCreate, bool searchInObjectHierarchy = true )
        {
            if ( _instance == null )
            {
                ...
                if ( searchInObjectHierarchy )
                {
                    ...
                    var components = GameObject.FindObjectsByType<T>( FindObjectsSortMode.None );
#else
